...
CREATE INDEX IF NOT EXISTS idx_library_loans_teacher_id ON public.library_loans(teacher_id);
CREATE INDEX IF NOT EXISTS idx_library_loans_borrower_type ON public.library_loans(borrower_type);
CREATE INDEX IF NOT EXISTS idx_library_loans_status ON public.library_loans(loan_status);
CREATE INDEX IF NOT EXISTS idx_library_books_book_code ON public.library_books(book_code);
CREATE INDEX IF NOT EXISTS idx_library_books_available ON public.library_books(available)
WHERE available > 0;
