...
--
CREATE TYPE public.audit_category AS ENUM ('Fees', 'Staff');
--
-- Name: audit_direction; Type: TYPE; Schema: public; Owner: -
--
CREATE TYPE public.audit_direction AS ENUM ('In', 'Out');
--
-- Name: chat_sender_role; Type: TYPE; Schema: public; Owner: -
--
CREATE TYPE public.chat_sender_role AS ENUM ('parent', 'clinic');
--
...
--
CREATE TYPE public.fee_status AS ENUM ('standard', 'reduced');
--
...
--
CREATE FUNCTION public.format_ethiopian_phone(phone text) RETURNS text LANGUAGE plpgsql AS $$ BEGIN -- Remove any existing +251 prefix
...
--
CREATE FUNCTION public.sort_students_in_section() RETURNS trigger LANGUAGE plpgsql AS $$ BEGIN -- This is handled in application logic
RETURN NEW;
END;
$$;
--
...
--
CREATE UNIQUE INDEX idx_monthly_profit_targets_branch_period ON public.monthly_profit_targets USING btree (branch_id, ethiopian_month, target_year)
...
--
CREATE UNIQUE INDEX uq_grades_student_course_type_term ON public.grades USING btree (
    student_id,
    course_id,
    type,
    academic_year,
...
--
CREATE TRIGGER trg_academic_grades_updated BEFORE
...
--
CREATE TRIGGER trg_academic_sections_updated BEFORE
...
--
CREATE TRIGGER trg_exams_updated BEFORE
...
--
CREATE TRIGGER trg_inventory_updated BEFORE
...
--
CREATE TRIGGER trg_medicine_updated BEFORE
...
--
CREATE TRIGGER trg_pending_apps_upd BEFORE
...
--
CREATE TRIGGER trg_registration_config_updated BEFORE
...
--
CREATE TRIGGER trg_students_updated BEFORE
...
--
CREATE TRIGGER trg_teachers_updated BEFORE
...
--
CREATE TRIGGER trg_weekly_plans_upd BEFORE
